      ...
      <div className="bg-white">
        <div className="py-16 sm:py-24 xl:max-w-7xl xl:mx-auto xl:px-8">
          <div className="px-4 sm:px-6 sm:flex sm:items-center sm:justify-between lg:px-8 xl:px-0">
            <h2 className="text-3xl font-extrabold font-heading text-gray-800">Shop by Category</h2>
            <div className="hidden font-bold cursor-pointer  text-base font-heading text-gray-900 hover:text-primary sm:block">
